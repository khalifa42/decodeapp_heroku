...
class Component extends App{
	...
	homepage(){
		...
		(`<nav>
    <div class="nav-wrapper black text-lighten-4">
      <a href="#" class="brand-logo">&nbsp&nbsp&nbspRobson Sportscarft</a>
...
<div class="slider">
    <ul class="slides">
      <li>
        <img src="img/pin1.jpg"> <!-- random image -->
      ...
      <li>
        <img src="img/pin4.jpg"> <!-- random image -->
        <div class="caption left-align">
          
        </div>
      </li>
      <li>
        <img src="img/pin5.jpg"> <!-- random image -->
        <div class="caption center-left">
      </li>

      <li>
        <img src="img/pin12.png"> <!-- random image -->
        <div class="caption right-align">
          
        </div>
      </li>
      <li>
        <img src="img/pin11.jpg"> <!-- random image -->
        <div class="caption right-align">
   ...
   <div class="col s12 m7">
    ...
    <div class="card horizontal">
      <div class="card-image">
        <br><br><img src="img/pin01.png">
      </div>
      <div class="card-stacked">
        <div class="card-content black">
          <p class="white-text">SILVER WINGS
          						<br>
          						Set Includes:
          						<br>	 
								80% Tungsten Barrels
  ...
  <div class="col s12 m7">
    ...
    <div class="card horizontal">
      <div class="card-image">
       <br><br><img src="img/pin003.png">
      </div>
      <div class="card-stacked">
        <div class="card-content black">
          <p class="white-text">SLARIST GRIP-X
          						<br>
          						Set Includes:
          						<br>	 
								80% Tungsten Barrels
  ...
  <div class="col s12 m7">
    ...
    <div class="card horizontal">
      <div class="card-image">
        <br><br><img src="img/pin004.png">
      </div>
      <div class="card-stacked">
        <div class="card-content black">
          <p class="white-text">ESSEX
          						<br>
          						Set Includes:
          						<br>	 
								80% Tungsten Barrels
  ...
  <div class="col s12 m7">
    ...
    <div class="card horizontal">
      <div class="card-image">
        <br><br><img src="img/pin9.png">
      </div>
      <div class="card-stacked">
        <div class="card-content black">
          <p class="white-text">WINDSOR
          						<br>
          						Set Includes:
          						<br>	 
								80% Tungsten Barrels
...
<footer class="page-footer green text-lighten-4 ">
          <div class="container">
            <div class="row ">
